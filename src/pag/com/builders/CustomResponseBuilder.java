...
public class CustomResponseBuilder {
	...
	public static <T> ResponseBuilder buildResponseForObject(T object, Request request) {
	...
	public static <T> ResponseBuilder buildResponseForList(List<T> list, Request request) {
		CacheControl cc = new CacheControl();
		cc.setMaxAge(86400);
		cc.setPrivate(true);
