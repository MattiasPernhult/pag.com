...
public class CustomJSONBuilder {
	...
	public static String buildActors(List<ActorBean> actors) {
		JsonElement actorElement = gson.toJsonTree(actors);
		JsonObject jsonObject = new JsonObject();
		jsonObject.add("actors", actorElement);
	...
	public static String buildMovieSnackDrink(MovieBean movie,
			SnacksBean snack, Object object) {
		JsonElement movieElement = gson.toJsonTree(movie);
		JsonElement snackElement = gson.toJsonTree(snack);
		JsonElement drinkElement = gson.toJsonTree(object);
		JsonObject json = new JsonObject();
